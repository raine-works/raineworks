 ...
 *
 * Uses the official GitHub SVG from Simple Icons instead of Lucide's
 * deprecated brand icon. Supports className prop for sizing and styling.
 *
 * @module components/github-icon
 */
